...
-------------- PRESET --------------
Logger.debug("----- Loading Mikes OP Weapons preset -----")

-- Import the OOTB preset
require("ootb/main")

Logger.debug("----- Mikes OP Weapons Preset Applied -----")

-------------- SERVER INFO --------------

ServerSettings.Description = "Mikes OP Weapons"
ServerSettings.Motd = "Todo: pistols, snipers, falcon, impact, nj4, nj5, flak, efg, saber, chaff, motion sensor, mines, gladiator, medium packs, utility packs, shield packs"
...
-- ServerSettings.RabbitScoreLimit = 50
-- ServerSettings.RespawnTime = 1
-- ServerSettings.AmmoPickupLifespan = 30
