...
local itemDefs = {
    ...
    -- ProjectileLifespan = 10.0, -- Projectile weapons
    ...
    },
    {
        ...
        changes={
            ...
            MinDamageProportion = 1.0,
            ProjectileLifespan = 0.2,
            ProjectileInheritance = 1.1,
            DoesGibOnKill = true,
            GibStrength = 100.0,
            ClipAmmo = 50,
            FireInterval = 0.1,
    ...
    },
    {
        ...
        changes={
            ...
            MinDamageProportion = 1.0,
            ProjectileLifespan = 0.1,
            ProjectileInheritance = 0,
            SelfImpactMomentumMultiplier = -1,
            SelfImpactExtraZMomentum = 2,
            DoesGibOnKill = true,
            GibStrength = 100.0,
            ClipAmmo = 15,
            FireInterval = 0.1,
    ...
    },
    {
        ...
        changes={
            ...
            ProjectileInheritance = 1.0,
            ImpactMomentum = 1.0,
            SelfImpactMomentumMultiplier = 50000,
        },
        valueMods={
            -- TODO Add Value mods.
        },
    ...
    },
    {
        ...
        changes={
            -- TODO Add Property Changes.
            SelfImpactExtraZMomentum = 100000,
            SpareAmmo = 999,
            Damage = 1.0,
            FuseTimer = 0.05,
            ThrowDelay = 0.05,
            ThrowPullPinTime = 0.05,
            ProjectileInheritance = 1.1,
            ExplosiveRadius = 5000,
        },
        valueMods={
            -- TODO Add Value mods.
        },
