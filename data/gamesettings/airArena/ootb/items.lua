...
itemChangeDefs = {
    ...
    mods = {
        ...
        ---------------------
        {
            ...
            changes={
                Damage = 1,
                ImpactMomentum = 1000000,
                --Damage = 900,
            },
            class="Medium", -- Will apply across classes 
            name="Melee", 
            changes={
                Damage = 1,
                ImpactMomentum = 1000000,
            ...
            class="Heavy", -- Will apply across classes 
            name="Melee", 
            changes={
                Damage = 1,
                ImpactMomentum = 1000000,
